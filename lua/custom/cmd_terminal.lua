...
M.border = "rounded"
M.winblend = 8 -- slightly different from PowerShell (10)
M.title = "CMD"
...
function M.toggle()
  ...
  -- Window geometry
  local width = math.floor(vim.o.columns * 0.650)
  ...
  -- Launch CMD
  state.chan = vim.fn.termopen("cmd.exe", {
    cwd = target_cwd,
    on_exit = function()
